...
export default function Hello() {
  ...
  return (
    ...
    <div>
      <span className="text-blue-400">const</span> <span className="text-green-400">telephoneNum</span> 
    ...
    <div>
      <span className="text-blue-400">const</span> <span className="text-green-400">email</span>
       <span className="text-white"> = </span>
    ...
    <div>
      <span className="text-blue-400">const</span> <span className="text-green-400">githubLink</span> 
      <span className="text-white"> = </span>
    ...
    <div>
      <span className="text-blue-400">const</span> <span className="text-green-400">linkedinPage</span> 
      <span className="text-white"> = </span>
