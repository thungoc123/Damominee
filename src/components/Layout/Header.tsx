  ...
  return (
    <header className="w-full px-6 flex items-center justify-between bg-[#0f1117] text-sm font-mono border-b border-white/10">
      <div className="flex items-center">
        <Link href="/" className="text-pink-400 hover:text-pink-300 px-10">
          Damominee
        </Link>
      ...
      <a
        ...
        className="p-4 px-5 text-pink-400 hover:text-pink-300 border-l border-b-0 border-r border-white/10"
      >
        _contact-me
      </a>
    </header>
