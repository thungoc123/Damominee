...
export default function AudioCard() {
     return (
          <div className="bg-gray-900 border border-white/10 rounded-xl shadow p-4">
               <h3 className="font-semibold text-cyan-400 mb-2">Series Currently Reading</h3>
               <div className="flex items-start gap-4">
                    ...
                    <div className="flex flex-col flex-1">
                         ...
                         <div className="flex justify-between items-start">
                              <p className="flex items-start text-sm font-semibold bg-gray-800 p-2 text-cyan-400">
